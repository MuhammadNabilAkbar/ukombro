...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-primary">Edit User {{ $user->nama }}</h3> </div>
		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<form class="form-valide" action="{{ action('MasterController@updateuser', $id) }}" method="post">
								@csrf
								<div class="form-validation">
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="val-username">Nama <span class="text-danger">*</span></label>
										<div class="col-lg-6">
											<input value="{{ $user->nama }} " type="text" class="form-control" id="val-username" name="nama" placeholder="Nama">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="val-email">Telepon <span class="text-danger">*</span></label>
										<div class="col-lg-6">
											<input value="{{ $user->telepon }} " type="text" class="form-control" name="telepon" placeholder="Telepon">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input value="{{ $user->password }} " type="password" class="form-control" id="val-website" name="password" placeholder="Password">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<select value="{{ $user->hakakses }} " class="form-control" id="val-skill" name="hakakses">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<form action="#" class="dropzone">
												<div class="fallback">
													<input value="{{ $user->foto }}" name="foto" type="file" multiple />
												</div>
											</form>
										</div>
									</div>
